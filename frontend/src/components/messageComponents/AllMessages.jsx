                        ...
                        <Fragment key={message._id}>
                            ...
                            >
                                {message?.chat?.isGroupChat &&
                                    ...
                                    message?.sender?._id ? (
                                        <Avatar
                                            src={message?.sender?.image ? `${import.meta.env.VITE_BACKEND_URL}${message?.sender?.image}` : null}
                                                    ...
                                                    <div className="relative bg-slate-700 rounded-lg max-w-64 overflow-hidden">
                                                        {downloadedImages.has(message._id) ? (
                                                            ...
                                                            <div className="relative">
                                                                <img
                                                                    src={`${import.meta.env.VITE_BACKEND_URL}${message.file}`}
                                                                    alt="Shared image"
                                                                    className="w-full max-h-64 object-cover cursor-pointer hover:opacity-90 transition-opacity"
                                                                    onClick={() => window.open(`${import.meta.env.VITE_BACKEND_URL}${message.file}`, '_blank')}
                                                                />
                                                                ...
                                                                <button 
                                                                    ...
                                                                    onClick={(e) => {
                                                                        ...
                                                                        link.href = `${import.meta.env.VITE_BACKEND_URL}${message.file}`;
                                                                        link.download = message.file.split('/').pop();
                                                            ...
                                                            <div className="p-4 cursor-pointer hover:bg-slate-600 transition-colors">
                                                                <div className="flex items-center gap-3">
                                                                    ...
                                                                    <div className="flex-1">
                                                                        ...
                                                                        <div className="text-gray-400 text-xs">{message.file.split('/').pop()}</div>
                                                                    </div>
                                                                    <button 
                                                                        ...
                                                                        onClick={(e) => {
                                                                            ...
                                                                            setDownloadedImages(prev => new Set([...prev, message._id]));
                                                                        }}
                                                                        title="Load image"
                                                                    >
                                                                        <HiDownload className="text-white text-sm" />
                                                    ...
                                                    <div className="relative bg-slate-700 rounded-lg p-4 max-w-64 cursor-pointer hover:bg-slate-600 transition-colors">
                                                        <div className="flex items-center gap-3">
                                                            ...
                                                            <button 
                                                                ...
                                                                onClick={(e) => {
                                                                    e.stopPropagation();
                                                                    window.open(`${import.meta.env.VITE_BACKEND_URL}${message.file}`, '_blank');
                                                                }}
                                                                title="Open PDF"
                                                            >
